...
## ALT FØR DETTE ER BARE PISS(evt endre timezone). HER ER DET MAN GJØR:

# Install Active Directory Domain Services (AD DS)
# Needs to be run as Administrator
Install-WindowsFeature AD-Domain-Services, DNS -IncludeManagementTools ## kjør først denne
$Password = Read-Host -Prompt 'Enter Password' -AsSecureString ## så denne, husk PW
Set-LocalUser -Password $Password Administrator ## Så denne
...
Install-ADDSForest @Params ## så denne
Restart-Computer ## så denne
