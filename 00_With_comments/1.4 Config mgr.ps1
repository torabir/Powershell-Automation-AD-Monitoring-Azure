...
# Konfigurer Git
git config --global user.name "Tor Arne Birkeland"
git config --global user.email "torabir@stud.ntnu.no"
#

# Mer om konfigurering av git: https://www.theodinproject.com/lessons/foundations-setting-up-git
